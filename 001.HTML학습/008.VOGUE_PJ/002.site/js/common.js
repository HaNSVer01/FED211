// 보그 코리아 공통 기능JS - common.js 
$(function () { //////////// jQB ////////////
    // 페이지 새로 고침시 스크롤이 중간에 있으면 
    // 브라우저 스크롤위치 캐싱(즉, 위치기억)에 의해서
    // 그 위치에 있게되므로 강제로 위로 보내는 코드를 넣어준다!
    // css로 넣어주면 캐싱이 덮어써서 소용이 없다!
    // 그래서 animate로 넣어줌
    $("html,body").animate({
        scrollTop: "0px"
    }, 100);
    ...
    /* 
        ...
        1. 스크롤 이벤트는 스크롤 바가 움직일때 발생한다.
        (마우스휠 이벤트와 다름!)
        2. 제이쿼리에서 scroll() 메서드로 구현함
        3. 스크롤 위치값은 scrollTop() 매서드로 알아낸다!
    */
    ...
    $(window).scroll(function () {
        ...
        if(scTop >= 300 && scSts2===1){
            scSts2 = 0; //한번만!
            console.log("탑버튼보여!");
            tbtn.fadeIn(300); //스윽보여 
        } /////////////// if ////////////////
        else if(scTop < 300 && scSts2===0){
            scSts2 = 1; //한번만
            console.log("탑버튼숨기기");
            tbtn.fadeOut(300); // 스윽숨겨
        } //////////// else if ////////////
