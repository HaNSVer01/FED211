...
$(function () { /////// jQB ///////////////////
    ...
    */
    ...
    ///////////// 이메일 검사 결과 처리 함수 //////////////////
    ///////////////////////////////////////////////////////
    let resEml = comp => { // comp (complete - 완성된 이메일 주소 resEml 이메일 결과)
    ...
    // 과연 글자가 입력되는 순간은 어떤 키보드 이벤트는 써야할까?
    ...
    seleml.change(function () {
        ...
        if (cv === "init") { ///// "선택해주세요" 선택시
            ...
            // 1.`직접입력창보이기(fadeIn) + 값초기화(val) + 포커스주기(focus)
...
function vReg(val, cid) {
    ...
    // 검사할 아이디에 따라 정규식을 변경함 g는 global 전체를 의미 
    switch (cid) {
        case "mid": // 아이디
